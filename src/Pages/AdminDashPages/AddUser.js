...
const AddUser = () => {
  ...
  const getDecryptedPassword = async (userId, encryptedPassword) => {
    ...
    try {
      ...
      const response = await userService.getDecryptedPassword(encryptedPassword);
                        ...
                        >
                          ...
                          <TableCell>
                            <Chip 
                              label={user.RoleName} 
                              sx={{ 
                                backgroundColor: roleColors[user.RoleID]?.bg || '#f5f5f5',
      ...
      >
        ...
        <DialogContent sx={{ pt: 3 }}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth size="small" error={!!formErrors.roleId} sx={{ mb: 2 }}>
